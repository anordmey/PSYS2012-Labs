...
-   1 pt: Copy the R code that you used to answer the expression above.
-   1 pt: Report the output of the object `a` (you can get the output by just typing `a` at the bottom of the code block - R will print out what is stored in that object.)
:::
...
What is the mean age for participants in the math_anxiety data? Report your answer using a *complete sentence* (e.g., "The mean age of participants is _____.")

*Rubric for Question 3b (2 points total):*

-   1 pt: Correctly report the mean age of participants.
-   1 pt: Professionalism - write your answer as a complete sentence.
:::
